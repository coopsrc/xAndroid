package com.coopsrc.xandroid.dewdrops.utils;
...
public class BitmapUtils {
    ...
    public static Bitmap getViewBitmap(View view, int translateX, int translateY, float sampleFactor) {
        ...
        if (view.getBackground() != null && view.getBackground() instanceof ColorDrawable) {
            ...
            bitmap.eraseColor(Color.parseColor("#EAEAEA"));
        }

        Canvas canvas = new Canvas(bitmap);
        canvas.translate(-(int) (translateX * scale), -(int) (translateY * scale));
