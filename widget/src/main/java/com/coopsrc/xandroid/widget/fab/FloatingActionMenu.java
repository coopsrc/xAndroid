package com.coopsrc.xandroid.widget.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = DimensionUtils.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = DimensionUtils.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = DimensionUtils.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = DimensionUtils.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = DimensionUtils.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = DimensionUtils.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = DimensionUtils.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = DimensionUtils.dpToPx(getContext(), 3f);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = DimensionUtils.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = DimensionUtils.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = DimensionUtils.dpToPx(getContext(), mMenuShadowYOffset);
        }
